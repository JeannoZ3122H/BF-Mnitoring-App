...
@section('title', 'Liste des rapports annotés')
                ...
                <div class="mail-wrapper">
                    ...
                    <div class="mail-content">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <!-- id="list-mail-1" si animation alors ajoute a la place de id="list-mail-0" -->
                            <div class="tab-pane fade show active" id="list-mail-0" role="tabpanel" aria-labelledby="list-mailtab-1">
                                                    ...
                                                    <td class="mail-option">12 Jul 22 08:23 AM
                                                        <div class="mail-buttons">
                                                            <ul class="list-inline mb-0">
                                                                ...
                                                                <li class="list-inline-item">
                                                                    <a href="#" class="avtar avtar-s btn-link-warning" data-bs-toggle="modal" data-bs-target="#Phase3"><i class="ti ti-pencil f-18"></i></a>
                                                                </li>
                                                                <li class="list-inline-item">
                                    ...
                                    <div class="modal fade" id="Phase3" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content p-2">
                                                <h1 class="m-b-10 h1 text-center fw-bold"><span class="color-green text-sw-1 fw-bolder">R</span>apport <span class="color-green text-sw-1 fw-bolder">A</span>nnoté</h1>
                                                <div class="mail-content mt-2 rounded bg-light p-4">
                                                    <div class="tab-content" id="nav-tabContent">
                                                        
                                                        <div class="mail-details mb-3 mt-2">
                                                            <hr class="mb-3 mt-2">
                                                            <h5 class="mb-3"><b><i class="material-icons-two-tone me-2">sticky_note_2</i> Rapport</b></h5>
                                                            <div class="contenu_rapport page-header">
                                                                voici le contenu
                                                            </div>
                                                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <form class="form">
                                                                <div class="col-12">
                                                                    <label for="faute">Choississez la faute</label>
                                                                    <select class="form-select" size="10" id="faute" name="faults" aria-label="size 10 select example">
                                                                        <option selected>Aucune</option>
                                                                        <option value="1">Faute 1</option>
                                                                        <option value="2">Faute 2</option>
                                                                        <option value="3">Faute 3</option>
                                                                        <option value="4">Faute 4</option>
                                                                        <option value="5">Faute 5</option>
                                                                        <option value="6">Faute 6</option>
                                                                        <option value="7">Faute 7</option>
                                                                        <option value="8">Faute 8</option>
                                                                    </select>
                                                                    <center>
                                                                        <div class="mt-3 mb-2">
                                                                            <button class="btn text-bg-success btn-sw-1 fw-bold" type="submit">Valider la faute</button>
                                                                        </div>
                                                                    </center>
                                                                </div>
                                                            </form>
