...
@include('layouts.frontend.phase_3.front_sidebar_step_1')


<div class="pc-container bg-light bloc-sw-1">
    <div class="pc-content">
        <div class="page-header bloc-sw">
            <h1 class="h3" style="text-align: center">Repertoire des rapports</h1>
        </div>
        <div class="row">
                                                    ...
                                                    <td class="mail-option">12 Jul 22 08:23 AM
                                                        <div class="mail-buttons">
                                                            <ul class="list-inline mb-0">
                                                                ...
                                                                <li class="list-inline-item">
                                                                    <a href="#" class="avtar avtar-s btn-link-warning" data-bs-toggle="modal" data-bs-target="#Phase2"><i class="ti ti-pencil f-18"></i></a>
                                                                </li>
                                                                <li class="list-inline-item">
                                    ...
                                    <div class="modal fade" id="Phase2" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content p-2">
                                                <h1 class="m-b-10 h1 text-center fw-bold"><span class="color-green text-sw-1 fw-bolder">A</span>nnotion de <span class="color-green text-sw-1 fw-bolder">R</span>apport </h1>
                                                        ...
                                                        <div class="form-group">
                                                            <form class="form">
                                                                <div class="col-12">
                                                                    ...
                                                                    <center>
                                                                        <div class="mt-3 mb-2">
                                                                            <button class="btn text-bg-success btn-sw-1 fw-bold" type="submit">Valider l{{('\'')}}annotaion</button>
                                                                        </div>
                                                                    </center>
                                                                </div>
                                                            </form>
                                ...
                                <div class="card">
                                    <div class="card-body scroll-block">
                                        ...
                                        <div class="mail-details">
                                            <hr class="mb-3 mt-2">
                                            <h5 class="mb-3"><b><i class="material-icons-two-tone me-2">menu_book</i> rapport</b></h5>
                                            <!-- contenu du rapport -->
                                            <div class="container mt-3">
                                                <div class="page-header col-12 bg-light">
                                                    titre <br/>
                                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.been the industry's standard dummy
