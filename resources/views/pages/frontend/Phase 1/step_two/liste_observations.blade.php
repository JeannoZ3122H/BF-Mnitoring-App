...
<div class="pc-container bg-light bloc-sw-1">
    <div class="pc-content">
        <div class="page-header bloc-sw">
            <h1 class="h3" style="text-align: center">Liste des observations</h1>
        </div>
        <div class="row">
                                                    ...
                                                    <td class="mail-option">12 Jul 22 08:23 AM
                                                        <div class="mail-buttons">
                                                            <ul class="list-inline mb-0">
                                                                ...
                                                                <li class="list-inline-item">
                                                                    <a href="#" class="avtar avtar-s btn-link-primary sw-none "><i class="ti ti-check f-18"></i></a>
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <a href="#" class="avtar avtar-s btn-link-warning" data-bs-toggle="modal" data-bs-target="#Phase1"><i class="ti ti-pencil f-18"></i></a>
                                                                </li>
                                                                <li class="list-inline-item">
                                    ...
                                    <div class="modal fade" id="Phase1" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content p-2">
                                                <h1 class="m-b-10 h1 text-center fw-bold"><span class="color-green text-sw-1 fw-bolder">F</span>ormulaire <span class="color-green text-sw-1 fw-bolder">O</span>bservation</h1>
                                                        ...
                                                        <form action="" method="post">
                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="mb-2 col-md-6 col-12">
                                                                            ...
                                                                            <div class="mb-2 ">
                                                                                ...
                                                                                <input class="form-control input-sw" id="formFileLg" type="file">
                                                                            </div>
                                                                            <div class="mb-2 ">
                                                                        ...
                                                                        <div class="mb-2">
                                                                            <label for="exampleFormControlTextarea1" class="form-label">Le type de la faute</label>
                                                                ...
                                                                <div class="mb-2">
                                                                    ...
                                                                    <textarea class="form-control input-sw" id="exampleFormControlTextarea1" rows="4" placeholder="Commentaire"></textarea>
                                                                </div>
                                                                <center>
                                                                    <div class="mt-3 mb-2">
                                                                        <button class="btn text-bg-success btn-sw-1 fw-bold" type="submit">Valider les modifications</button>
                                                                    </div>
                                                                </center>
                                                            </div>
                                                        </form>
