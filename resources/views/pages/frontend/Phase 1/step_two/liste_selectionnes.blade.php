                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="card follower-card shadow zoom-1">
                                    ...
                                    <div class="media align-items-center mb-3">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end py-1">
                                                ...
                                                <a class="dropdown-item d-flex" data-bs-toggle="modal" data-bs-target="#Phase1">
                                                    <i class="ti ti-eye fw-bold"></i> 
                                                    <span class="ms-2">Voir</span> 
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-2 ms-auto me-2">
                                            <div class="d-grid">
                    ...
                    <div class="modal fade" id="Phase1" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
                        <div class="modal-dialog modal-fullscreen">
                            <div class="modal-content p-2">
                                <h1 class="m-b-5 h1 text-center fw-bold"><span class="color-green text-sw-1 fw-bolder">D</span>étails <span class="color-green text-sw-1 fw-bolder">O</span>bservations</h1>
